const translations = {
  en: {
    ...
    "nav.contact": "Contact",
    "hero.eyebrow": "Thailand, Vietnam & Southeast Asia Growth Partner",
    "hero.title": "Localize, launch, and scale your brand across Southeast Asia.",
    "hero.copy":
      "LOUDER Creative helps brands enter Thailand, Vietnam, and Southeast Asia through localized marketing, KOL/KOC activation, content operations, commerce setup, and data-driven growth.",
    ...
    "intro.copy":
      "We are a cross-border marketing and commercialization partner focused on helping Chinese brands localize, promote, sell, and scale in Thailand, Vietnam, and Southeast Asia.",
    ...
    "why.experience.copy":
      "The team has hands-on experience across China, Thailand, Vietnam, and Singapore in cross-border commerce and brand marketing.",
    ...
    "services.live.copy":
      "Thailand-based livestream execution, creator coordination, run-of-show design, and conversion optimization.",
    ...
    "footer.copy": "Thailand, Vietnam, and Southeast Asia growth operations.",
    "menu.open": "Open menu",
  ...
  ms: {
    ...
    "nav.packages": "Pakej",
    "nav.contact": "Hubungi",
    "hero.eyebrow": "Rakan Pertumbuhan Thailand, Vietnam & Asia Tenggara",
    "hero.title": "Setempatkan, lancarkan, dan skala jenama anda di Asia Tenggara.",
    "hero.copy":
      "LOUDER Creative membantu jenama memasuki Thailand, Vietnam dan Asia Tenggara melalui pemasaran setempat, aktivasi KOL/KOC, operasi kandungan, persediaan dagang, dan pertumbuhan berasaskan data.",
    ...
    "intro.copy":
      "Kami ialah rakan pemasaran rentas sempadan dan komersialisasi yang membantu jenama China menyesuaikan diri, mempromosi, menjual, dan berkembang di Thailand, Vietnam serta Asia Tenggara.",
    "stats.eyebrow": "Portfolio",
    ...
    "why.experience.copy": "Pasukan mempunyai pengalaman langsung di China, Thailand, Vietnam, dan Singapura dalam dagang rentas sempadan dan pemasaran jenama.",
    ...
    "services.live.copy": "Pelaksanaan livestream di Thailand, koordinasi kreator, reka aliran siaran, dan pengoptimuman penukaran.",
    ...
    "footer.copy": "Operasi pertumbuhan Thailand, Vietnam dan Asia Tenggara.",
    "menu.open": "Buka menu",
  ...
  th: {
    ...
    "nav.contact": "ติดต่อ",
    "hero.eyebrow": "พาร์ทเนอร์การเติบโตในไทย เวียดนาม และเอเชียตะวันออกเฉียงใต้",
    "hero.title": "ปรับแบรนด์ให้เข้าท้องถิ่น เปิดตลาด และขยายในเอเชียตะวันออกเฉียงใต้",
    "hero.copy":
      "LOUDER Creative ช่วยแบรนด์เข้าสู่ไทย เวียดนาม และเอเชียตะวันออกเฉียงใต้ผ่านการตลาดท้องถิ่น การทำงานกับ KOL/KOC การดูแลคอนเทนต์ การตั้งค่าคอมเมิร์ซ และการเติบโตจากข้อมูล",
    ...
    "intro.copy":
      "เราเป็นพันธมิตรด้านการตลาดข้ามพรมแดนและการทำธุรกิจเชิงพาณิชย์ ที่ช่วยแบรนด์จีนปรับตัว โปรโมต ขาย และเติบโตในไทย เวียดนาม และเอเชียตะวันออกเฉียงใต้",
    "stats.eyebrow": "ผลงาน",
    ...
    "why.experience.copy": "ทีมมีประสบการณ์จริงในจีน ไทย เวียดนาม และสิงคโปร์ ด้านคอมเมิร์ซข้ามพรมแดนและการตลาดแบรนด์",
    ...
    "footer.copy": "บริการเติบโตในไทย เวียดนาม และเอเชียตะวันออกเฉียงใต้",
    "menu.open": "เปิดเมนู",
    "menu.close": "ปิดเมนู",
  },
  zh: {
    ...
    "nav.packages": "套餐",
    "nav.contact": "联系",
    "hero.eyebrow": "泰国、越南与东南亚增长伙伴",
    "hero.title": "帮助品牌在东南亚本地化落地、推广、销售与增长。",
    "hero.copy":
      "LOUDER Creative 聚焦泰国、越南与东南亚市场，通过本地化营销、KOL/KOC 投放、内容运营、电商搭建与数据驱动增长，帮助品牌进入并放大海外市场。",
    "hero.primary": "联系我们",
    "hero.secondary": "查看服务",
    "signal.one": "KOL/KOC 激活",
    "signal.two": "内容运营",
    "signal.three": "电商增长",
    "intro.copy": "我们是跨境营销与商业化服务伙伴，专注帮助中国品牌在泰国、越南与东南亚实现本土化落地、推广、销售与规模化增长。",
    "stats.eyebrow": "项目能力",
    ...
    "why.experience.copy": "团队拥有中国、泰国、越南、新加坡跨境电商与品牌营销实操经验。",
    "services.eyebrow": "服务",
...
const translationAdditions = {
  en: {
    ...
    "lead.marketPlaceholder": "Thailand, Vietnam, Malaysia, SEA...",
    ...
    "intro.copy":
      "We are a cross-border marketing and commercialization partner focused on helping Chinese brands localize, promote, sell, and scale in Thailand, Vietnam, and Southeast Asia.",
    "visual.title": "Thailand, Vietnam & Southeast Asia",
    "team.eyebrow": "Team Background",
    "team.title": "Southeast Asia-local execution with cross-market operators",
    "team.local.title": "Thailand & Vietnam Market Resources",
    "team.local.copy": "Thailand and Vietnam market resources connected with a Hangzhou office rhythm for faster coordination.",
    ...
    "team.operator.copy": "More than two years of hands-on work across China, Thailand, Vietnam, and Singapore commerce and brand marketing.",
    "footer.copy": "Thailand, Vietnam, and Southeast Asia growth operations.",
    "cases.eyebrow": "Product Motion",
    "cases.title": "Logo-free product categories in motion",
    "cases.copy": "A brand-safe interface for consumer categories we can localize, seed, operate, and scale.",
    "product.kicker": "Logo-free category motion",
  ...
  ms: {
    ...
    "intro.copy":
      "Kami ialah rakan pemasaran rentas sempadan dan komersialisasi yang membantu jenama China menyesuaikan diri, mempromosi, menjual, dan berkembang di Thailand, Vietnam serta Asia Tenggara.",
    "visual.title": "Thailand, Vietnam & Asia Tenggara",
    "team.eyebrow": "Latar Pasukan",
    "team.title": "Pelaksanaan tempatan Asia Tenggara dengan operator rentas pasaran",
    "team.local.title": "Sumber Pasaran Thailand & Vietnam",
    "team.local.copy": "Sumber pasaran Thailand dan Vietnam diselaraskan dengan rentak pejabat Hangzhou untuk koordinasi yang lebih pantas.",
    ...
    "team.operator.copy": "Lebih dua tahun pengalaman langsung dalam dagang dan pemasaran jenama di China, Thailand, Vietnam, dan Singapura.",
    "footer.copy": "Operasi pertumbuhan Thailand, Vietnam dan Asia Tenggara.",
    "cases.eyebrow": "Gerak Produk",
    "cases.title": "Kategori produk tanpa logo dalam gerakan",
    "cases.copy": "Antara muka selamat jenama untuk kategori pengguna yang boleh kami setempatkan, seed, operasi, dan skala.",
    "product.kicker": "Gerakan kategori tanpa logo",
  ...
  th: {
    ...
    "hero.eyebrow": "พาร์ทเนอร์การเติบโตในไทย เวียดนาม และเอเชียตะวันออกเฉียงใต้",
    "hero.copy":
      "LOUDER Creative ช่วยแบรนด์เข้าสู่ไทย เวียดนาม และเอเชียตะวันออกเฉียงใต้ผ่านการตลาดท้องถิ่น การทำงานกับ KOL/KOC การดำเนินคอนเทนต์ การตั้งระบบคอมเมิร์ซ และการเติบโตด้วยข้อมูล",
    ...
    "lead.marketPlaceholder": "ไทย เวียดนาม มาเลเซีย SEA...",
    ...
    "intro.copy":
      "เราเป็นพาร์ทเนอร์การตลาดและคอมเมิร์ซข้ามพรมแดนที่ช่วยแบรนด์จีนปรับตัว โปรโมต ขาย และเติบโตในไทย เวียดนาม และเอเชียตะวันออกเฉียงใต้",
    "visual.title": "ไทย เวียดนาม และเอเชียตะวันออกเฉียงใต้",
    "team.eyebrow": "ทีมงาน",
    "team.title": "ทีมปฏิบัติการท้องถิ่นในเอเชียตะวันออกเฉียงใต้ พร้อมผู้ดูแลหลายตลาด",
    "team.local.title": "ทรัพยากรตลาดไทยและเวียดนาม",
    "team.local.copy": "ทรัพยากรตลาดไทยและเวียดนามประสานกับจังหวะการทำงานของสำนักงานหางโจวเพื่อการทำงานที่รวดเร็วขึ้น",
    ...
    "team.operator.copy": "ประสบการณ์มากกว่าสองปีในจีน ไทย เวียดนาม และสิงคโปร์ด้านคอมเมิร์ซและการตลาดแบรนด์",
    "footer.copy": "บริการเติบโตในไทย เวียดนาม และเอเชียตะวันออกเฉียงใต้",
    "cases.eyebrow": "สินค้าเคลื่อนไหว",
    "cases.title": "หมวดสินค้าที่ไม่มีโลโก้ในอินเทอร์เฟซเคลื่อนไหว",
    "cases.copy": "อินเทอร์เฟซที่ปลอดภัยต่อแบรนด์สำหรับหมวดสินค้าอุปโภคบริโภคที่เราสามารถทำโลคัลไลซ์ seeding ดำเนินงาน และขยายผลได้",
    "product.kicker": "หมวดสินค้าไร้โลโก้",
  ...
  zh: {
    ...
    "hero.eyebrow": "泰国、越南与东南亚增长伙伴",
    "hero.copy":
      "LOUDER Creative 帮助品牌进入泰国、越南与东南亚市场，覆盖本地化营销、KOL/KOC 激活、内容运营、电商搭建与数据驱动增长。",
    "hero.primary": "免费咨询",
    ...
    "lead.marketPlaceholder": "泰国、越南、马来西亚、东南亚...",
    "lead.noteLabel": "项目说明",
    ...
    "visual.eyebrow": "市场进入",
    "intro.copy":
      "我们是跨境营销与商业化伙伴，帮助中国品牌在泰国、越南与东南亚市场完成本地化、推广、销售与规模化增长。",
    "visual.title": "泰国、越南与东南亚",
    "team.eyebrow": "团队背景",
    "team.title": "东南亚本地执行资源与跨市场操盘经验",
    "team.local.title": "泰国与越南市场资源",
    "team.local.copy": "泰国与越南市场资源与杭州办公节奏协同，提升沟通和执行效率。",
    "team.alumni.title": "创始背景",
    "team.alumni.copy": "创始成员包括三位浙江大学校友，具备真实市场操盘经验。",
    "team.operator.title": "操盘经验",
    "team.operator.copy": "拥有两年以上中国、泰国、越南、新加坡跨境电商与品牌营销实操经验。",
    "footer.copy": "泰国、越南与东南亚增长运营服务。",
    "cases.eyebrow": "产品动势",
    "cases.title": "无 logo 的产品品类动态界面",
    "cases.copy": "以品牌安全的方式呈现可本地化、种草、运营和放大的消费品类。",
    "product.kicker": "无 logo 品类动势",
...
const setLanguage = (language) => {
  ...
  if (currentLanguageLabel && languageMeta[language]) {
    currentLanguageLabel.textContent = languageMeta[language].label;
  }

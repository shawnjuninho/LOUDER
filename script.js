...
const translationAdditions = {
  en: {
    ...
    "footer.copy": "Thailand, Vietnam, and Southeast Asia growth operations.",
    "cases.eyebrow": "Brand Cases",
    "cases.title": "Selected brand and platform collaborations",
    "cases.copy": "Experience spans consumer brands, platform campaigns, beauty, wellness, lifestyle, and commerce categories.",
  ...
  ms: {
    ...
    "footer.copy": "Operasi pertumbuhan Thailand, Vietnam dan Asia Tenggara.",
    "cases.eyebrow": "Kes Jenama",
    "cases.title": "Kolaborasi jenama dan platform terpilih",
    "cases.copy": "Pengalaman merangkumi jenama pengguna, kempen platform, kecantikan, kesihatan, gaya hidup, dan dagang.",
  ...
  th: {
    ...
    "footer.copy": "บริการเติบโตในไทย เวียดนาม และเอเชียตะวันออกเฉียงใต้",
    "cases.eyebrow": "กรณีแบรนด์",
    "cases.title": "ตัวอย่างความร่วมมือกับแบรนด์และแพลตฟอร์ม",
    "cases.copy": "ครอบคลุมแบรนด์ผู้บริโภค แคมเปญแพลตฟอร์ม ความงาม สุขภาพ ไลฟ์สไตล์ และคอมเมิร์ซ",
  ...
  zh: {
    ...
    "footer.copy": "泰国、越南与东南亚增长运营服务。",
    "cases.eyebrow": "品牌案例",
    "cases.title": "部分品牌与平台合作案例",
    "cases.copy": "案例覆盖消费品牌、平台活动、美妆个护、健康生活、生活方式与电商等品类。",
